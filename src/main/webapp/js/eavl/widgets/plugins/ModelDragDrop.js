 ...
 *
 *   handleDrop: function(Ext.Component me, Ext.data.Model model, Ext.Component source) - [optional] - A function that should handle the insertion of the specified Ext.data.Model. If omitted, this component will not receive drops
 *   handleDrag: function(Ext.Component me, Ext.data.Model model, Ext.Component source) - [optional] - A function that should handle the removal of the specified Ext.data.Model (it's been dragged elsewhere). If omitted, this component will not support dragging
 * }
 */
